...
Public Class fremMainWindow
    ...
    Private Sub Form2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        "what is your prefered song", "what is your best song", "ok show me", "open google maps", "how to fix slow in my windows", "Open youtube", "Internet Download", "What is my name")
    ...
    Private Sub reco_SpeechRecognized(ByVal sender As Object, ByVal e As System.Speech.Recognition.RecognitionEventArgs) Handles MyVoice.SpeechRecognized
        ...
        If (CheckBox1.Checked) Then
            ...
            If (e.Result.Text = "Open Youtube") Then
                Process.Start("https://www.youtube.com")
            End If

            If (e.Result.Text = "what is my name") Then
                SAPI.speak("your name is") 'so no we can use the API for it'
            End If
